...
export const profiles = {
  personal: {
    ...
    materialsIntro: "Tarkka vakuutusturva ja hinta varmistetaan asiantuntijan kanssa."
  },
  business: {
    id: "business",
    label: "Yritysasiakas",
  ...
  personal: {
    ...
    liability: {
      ...
      questions: [
        ...
        q("liabilityScope", "Miten haluat jatkaa?", "Valitse vaihtoehto, joka toimii asiantuntijan tarkistuksen pohjana.", false, [["home_bundle", "Tarkistetaan kodin vakuutuksen yhteydessä"], ["broader", "Haluan laajemman vastuu- ja oikeusturvatarkistuksen"], ["expert", "Haluan asiantuntijan arvion"], ["unsure", "En osaa sanoa"]])
      ]
    }
  },
  business: {
...
export const coverageModels = {
  personal: {
    ...
    travel: {
      ...
      notice: "Matkavakuutuksen sisältö ja voimassaolo riippuvat matkan kestosta, kohteesta, matkustajista ja valituista turvista. Lopullinen sisältö varmistetaan vakuutusehdoista tai asiantuntijan kanssa.",
      options: [
